...
@interface PPRSwipeTableViewCell () <UIScrollViewDelegate,  UIGestureRecognizerDelegate>
...
@implementation PPRSwipeTableViewCell
...
- (void)scrollViewWillEndDragging:(UIScrollView *)scrollView withVelocity:(CGPoint)velocity targetContentOffset:(inout CGPoint *)targetContentOffset
{
    ...
    if (_cellState != kCellStateCenter)
    {
        ...
        {
            for (PPRSwipeTableViewCell *cell in [self.containingTableView visibleCells]) {
                if (cell != self && [cell isKindOfClass:[PPRSwipeTableViewCell class]] && [self.delegate swipeableTableViewCellShouldHideUtilityButtonsOnSwipe:cell]) {
